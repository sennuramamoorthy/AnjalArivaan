...
Flow per new mail:
  ...
  4. If urgent:
       ...
       c. Publish mail.urgency_detected event to the outbox
...
from src.modules.notification.adapters.messaging.interface import IMessageBus
from src.modules.notification.adapters.whatsapp.interface import IWhatsAppAdapter
from src.modules.notification.domain.events import UrgencyDetectedEvent
