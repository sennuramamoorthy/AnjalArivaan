...
from src.adapters.llm.interface import ILLMAdapter
from src.adapters.template_store.interface import IPromptTemplateStore
from src.domain.context import AssembledContext
...
# Inline the Logger type so no hard dependency on the package path
try:
    from anjal_logger import Logger
except ImportError:
    # Fallback for environments without the package installed
    from src._logger_stub import Logger  # type: ignore
