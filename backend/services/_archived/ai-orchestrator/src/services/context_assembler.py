...
from src.domain.context import AssembledContext, RetrievedChunk
from src.domain.task import AITask, SummarizeRequest, DraftReplyRequest, DailyBriefingRequest
from src.repositories.interface import IRoleTemplateRepository
